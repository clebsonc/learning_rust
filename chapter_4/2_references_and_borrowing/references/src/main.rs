...
fn receive_reference(value: &String) -> usize {  // value is a reference to variable s fro mthe main function.
    value.len()
...
fn modify_reference(word: &mut String) { // receives a mutable reference of type String
    word.push_str(" World!");
}
